...
client.on('ready', () => {
  client.user.setGame('2help 2play ','https://www.twitch.tv/quastyle11');
  console.log('---------------');
...
const developers = ["411137717884289024","447112216123277335"]
client.on('message', message => {
...
const adminprefix = "2";
const devs = ['411137717884289024','447112216123277335'];
client.on('message', message => {
  var argresult = message.content.split(` `).slice(1).join(' ');
